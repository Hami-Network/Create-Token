...
contract HAMIRewardTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
contract HAMIRewardToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    HAMIRewardTokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = HAMIRewardTokenDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        HAMIRewardTokenDividendTracker newDividendTracker = HAMIRewardTokenDividendTracker(
            payable(newAddress)
        );
...
contract HAMIRewardTokenFactory is Ownable{
    ...
    function deploy(
        ...
        HAMIRewardToken token = new HAMIRewardToken(
            name_,
            symbol_,
            totalSupply_,
