...
contract HAMIBuyBackRewardToken is IERC20Extended, Auth, BaseToken {
    using SafeMath for uint256;
...
contract HAMIBuyBackRewardTokenFactory is Ownable{
    ...
    function deploy(
        ...
        HAMIBuyBackRewardToken token = new HAMIBuyBackRewardToken(
            name_,
            symbol_,
            totalSupply_,
            rewardToken_,
